...
function index() {
  return (
    <footer className="px-0 divide-y dark:bg-gray-800 dark:text-gray-100 mb-9 mt-3 bg-gradient-to-r from-gray-900 via-gray-900 to-green-800 py-4">
		
		{/* <div className='border-t-4 border-t-[#00745B]'></div> */}

		<div className="grid grid-cols-1 lg:grid-cols-4 gap-2 justify-items-center p-0 lg:p-2">
			<div className="grid grid-cols-1 gap-y-5 justify-items-center pl-4">
				...
				<div className='place-self-center lg:place-self-start grid grid-cols-4'>
                    <div className='min-w-sm w-8 h-8 bg-white rounded-full mx-2'></div>
                    <div className='min-w-sm w-8 h-8 bg-white rounded-full mx-2'></div>
                    <div className='min-w-sm w-8 h-8 bg-white rounded-full mx-2'></div>
                    <div className='min-w-sm w-8 h-8 bg-white rounded-full mx-2'></div>
                </div>
			</div>
			<div className="grid grid-cols-1 gap-y-0 justify-items-center mt-3 text-white">
				<div>
			...
			<div className="grid grid-cols-1 gap-y-0 justify-items-center mt-3">
				<div>
					<p className='font-bold'>Followus In</p>
				</div>
